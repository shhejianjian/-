...
#import "XHConst.h"
#define DefaultTextNomalColor [UIColor whiteColor]
#define DefaultTextSelectedColor [UIColor whiteColor]
...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        _textSelectedColor = XHGlobalColor;
        _lineColor = XHGlobalColor;
