...
- (void)viewDidLoad {
   ...
   [self.view insertSubview:[self makeScanCameraShadowViewWithRect:[self makeScanReaderInterrestRect]] atIndex:1];
    ...
    self.tiaoxingmaBtn.titleLabel.font = [UIFont fontWithName:kFontAwesomeFamilyName size:30];
    [self.tiaoxingmaBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [self.tiaoxingmaBtn setTitle:[NSString fontAwesomeIconStringForEnum:FAIconBarcode] forState:UIControlStateNormal];
    
    self.QRCodeBtn.titleLabel.font = [UIFont fontWithName:kFontAwesomeFamilyName size:30];
    [self.QRCodeBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [self.QRCodeBtn setTitle:[NSString fontAwesomeIconStringForEnum:FAIconQrcode] forState:UIControlStateNormal];
    
    self.flashBtn.titleLabel.font = [UIFont fontWithName:kFontAwesomeFamilyName size:20];
    [self.flashBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [self.flashBtn setTitle:[NSString fontAwesomeIconStringForEnum:FAIconBolt] forState:UIControlStateNormal];
}
